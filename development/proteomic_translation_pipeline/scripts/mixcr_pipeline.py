...
# This directory holds raw data from download links
# Raw holds nucleotides
raw_data_dir = os.path.join(data_set_dir, "raw")

# This directory holds the clones generated using MiXCR
# Clones holds protein clonotypes generated by MiXCR
clones_data_dir = os.path.join(data_set_dir, "clones")

# This is the path to the sql_db, which might not exist yet
sql_db = os.path.join(data_set_dir, f"{data_set}.db")



# If not skip directory,
...
# Extract fields for the sql database
...
# Make sure repertoires only contains directories
# These correspond to the repertoire names
repertoires = [
    rep for rep in repertoires if os.path.isdir(os.path.join(raw_data_dir, rep))
]
