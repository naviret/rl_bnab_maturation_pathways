...
parser.add_argument(
    ...
    type=str,
    default=["day"],
    help="additional database fields + DEFAULT repertoire path",
)
...
parser.add_argument(
    ...
    dest="skip_directory",
    action="store_true",
    help="skip directory set up & downloads. only MiXCR pipeline",
)
...
parser.add_argument(
    ...
    type=str,
    default="CONCISE",
    help="exportClones mode is either CONCISE or VERBOSE",
)
...
def download_with_aria(d_list):
    """
    Downloads linked files using aria2c.
    :return
        - process.returncode: process success
